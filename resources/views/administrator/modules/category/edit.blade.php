...
@section('title', title_module('category','edit'))
...
@section('content')
    <form action="{{ route('admin.category.update',['category' => $category->uuid]) }}" method="POST" enctype="multipart/form-data" class="formAjax">
        @csrf
        @method('PUT')
