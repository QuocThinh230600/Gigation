...
@section('title', title_module('language', 'edit'))
...
@section('content')
    <form action="{{ route('admin.language.update', ['language' => $language->uuid]) }}" method="POST" enctype="multipart/form-data" class="formAjax">
        @csrf
        @method('PUT')
