...
@section('title', title_module('product','create'))
...
@section('content')
    <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data" class="formAjax">
        @csrf
        @method('POST')
                ...
                <div class="card">
                    ...
                    <div class="bg-light">
                        <ul class="nav nav-tabs nav-tabs-bottom mb-0">
                            ...
                            <li class="nav-item">
                                <a href="#card-toolbar-tab3" class="nav-link" data-toggle="tab">
                                    <i class="icon-eyedropper2 mr-2"></i>
                                    {{ behavior('action.three_attribute') }}
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body tab-content" id="forms-target-left">
                        <div class="tab-pane fade show active" id="card-toolbar-tab1">
                            ...
                            {{-- <x-editor label="product.title" name="title" required="required">
                                {{ old('title') }}
                            </x-editor>
