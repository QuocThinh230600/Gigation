...
@section('title', title_module('image','edit'))
...
@section('content')
    <form action="{{ route('admin.image.update', ['image' => $image->uuid]) }}" method="POST" enctype="multipart/form-data" class="formAjax">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                <x-card title="action.info" id="forms-target-left">
                    ...
                    <x-editor label="images_position.script_code" name="script_code">
                        {{ old('script_code', $image->script_code) }}
                    </x-editor>

                    <x-editor label="images_position.description" name="description">
                        {{ old('description', $image->description) }}
                    </x-editor>
