...
<div class="alert bg-warning alert-styled-left alert-dismissible animated bounceInLeft" style="display: none">
    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
    <span class="font-weight-semibold">Warning!</span> <span class="message-warning"></span>
</div>

<div class="alert bg-danger alert-styled-left alert-dismissible animated bounceInLeft" style="display: none">
    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
    <span class="font-weight-semibold">Error!</span> <span class="message-danger"></span>
</div>
